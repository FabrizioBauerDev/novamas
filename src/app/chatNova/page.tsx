...
export const metadata: Metadata = {
  ...
  description: 'Conversa con tu asistente virtual para prevención y orientación sobre problematicas asociadas al juego online y apuestas. Obtén información, apoyo y recursos de ayuda.',
  ...
  openGraph: {
    ...
    description: 'Conversa tu asistente virtual para prevención de problemáticas asociadas al juego online.',
    type: 'website',
  }
};
